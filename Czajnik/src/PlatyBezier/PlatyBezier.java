...
public class PlatyBezier {
    ...
    int ile_platow;
    //tablica przechowuje wszystkie płaty i ich punkty(o współrzędnych X, Y, Z)
    double[][][] k = new double[4][4][3];
    String sciezka1 = "src/PlatyBezier/teacup1.txt";
    String sciezka2 = "src/PlatyBezier/teapot1.txt";
    String sciezka3 = "src/PlatyBezier/teaspoon1.txt";

    String sciezka4 = "src/PlatyBezier/teacup1bezier.txt";
    String sciezka5 = "src/PlatyBezier/teapot1bezier.txt";
    String sciezka6 = "src/PlatyBezier/teaspoon1bezier.txt";
    ...
    public Double bazowaBeziera(int m, int i, double v){
        return Math.pow(v,i) * Math.pow(1-v,m-i) * dwumianNewtona(m,i);
    }
